...
export class SalesController {
  constructor(
    ...
    private readonly applyItemDiscountUseCase: ApplyItemDiscountUseCase,
  ...
  removePayment(@Param("id") id: string, @Param("paymentId") paymentId: string) {
    return this.removePaymentUseCase.execute(id, paymentId);
  }
  ...
  applyItemDiscount(
    ...
    return this.applyItemDiscountUseCase.execute(id, itemId, body.discountAmount, user.userId);
  }
