...
/**
 * Motor de lembrete do Clube (Fase 3, 2026-09-14) — sem controller nenhum,
 ...
 * `CUSTOMER_REPOSITORY` — mesma direção de dependência já usada em
 * ClubModule/StoreCreditModule (feature puxa de outro módulo).
 */
@Module({
  imports: [BullModule.registerQueue({ name: CLUB_REMINDER_QUEUE_NAME }), ErpIntegrationModule, CustomersModule],
  providers: [
